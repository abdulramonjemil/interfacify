...
/**
 * Checks whether the first object inherits from the second. For example,
 * since 'new Array()' inherits from 'Array.prototype', this function will
 * return 'true' when passed the two values as arguments.
 */
...
/**
 * Makes the keys of enumerable properties in an object values, and the values
 * keys. When passed '{ name: "Alice" }' for example, it returns an object like
 * '{ Alice: "name" }'.
 */
