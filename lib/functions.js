...
function firstObjectInheritsFromSecond(firstObject, secondObject) {
  ...
  return firstObjectInheritsFromSecond(protoOfFirstObject, secondObject, true)
}
 ...
 * (in that order).
 */
function firstClassExtendsSecond(firstClass, secondClass) {
